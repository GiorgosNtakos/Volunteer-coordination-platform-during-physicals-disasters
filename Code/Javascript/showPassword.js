...
if (window.location.href === "http://localhost/webproject/Code/Html/login_signup.html") {
...
else if(window.location.href === "http://localhost/webproject/Code/Html/admin_login.html") {
    ...
    toggleLoginPassword.addEventListener('click', function () {
 ...
 else if(window.location.href === "http://localhost/webproject/Code/Html/admin_profile_setting.html") {
        ...
        const toggleRepeatNewPassword = document.getElementById('eye-repeatNew-password');
