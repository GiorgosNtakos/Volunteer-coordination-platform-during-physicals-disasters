...
$("#imageUpload").change(function() {
    ...
    $.ajax({
        type: "POST",
        url: "http://localhost/webproject/Code/PHP/upload_admin_photo.php",
        data: formData,
        contentType: false,
        processData: false,
        success: function(response) {
            ...
            showMessage("success-message", response.message, "showbox");
                ...
                showMessage("error-message","Ενώ η αλλαγή φωτογραφίας ήταν επιτυχής κάτι πήγε στραβά.Παρακαλώ δοκιμάστε ξανά", "showbox");
            }
        ...
        error: function(response) {
            ...
            if(errorResponse.status === "need_connection"){
                ...
                showMessage("error-message", errorResponse.message, "showbox");
                  ...
                  showMessage("error-message", "Σφάλμα κατά την διάρκεια αλλαγής κωδικού. Παρακαλώ δοκιμάστε ξανά.", "showbox");
              }
        }
    });   
   }
