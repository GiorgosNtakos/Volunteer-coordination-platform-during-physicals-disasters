...
CREATE TABLE users (
  user_id INT PRIMARY KEY AUTO_INCREMENT,  -- Πρωτεύον κλειδί, αυτόματο αύξοντας
...
CREATE TABLE products (
  ...
  category_id INT,  -- Εξωτερικό κλειδί που αναφέρεται στην κατηγορία του προϊόντος
  subcategory_id INT,  -- Εξωτερικό κλειδί που αναφέρεται στην υποκατηγορία του προϊόντος
...
CREATE TABLE categories (
  category_id INT PRIMARY KEY AUTO_INCREMENT,  -- Πρωτεύον κλειδί, αυτόματο αύξοντας
...
CREATE TABLE subcategories (
  subcategory_id INT PRIMARY KEY AUTO_INCREMENT,  -- Πρωτεύον κλειδί, αυτόματο αύξοντας
  name VARCHAR(255) NOT NULL,  -- Όνομα υποκατηγορίας, χωρίς να επιτρέπονται κενά
  category_id INT,  -- Εξωτερικό κλειδί που αναφέρεται στην κατηγορία της υποκατηγορίας
  FOREIGN KEY (category_id) REFERENCES categories(id)  -- Σύνδεση του category_id με το πρωτεύον κλειδί του πίνακα categories
);
